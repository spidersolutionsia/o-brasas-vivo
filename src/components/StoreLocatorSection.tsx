...
const storesByCity: CityLocation[] = [
  ...
  { city: 'Duas Barras', state: 'RJ', type: 'Fábrica', stores: ['Depósito Beerbarrense', 'Açougue Nossa Senhora Dua Barras', 'Alea', 'Açougue e Mercado Castelo', { name: 'Superthal', instagram: 'https://www.instagram.com/redesuperthal/', maps: 'https://maps.app.goo.gl/Kv2SmEQNbdU4EeYp6' }] },
