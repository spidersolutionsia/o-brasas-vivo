...
const storesByCity: CityLocation[] = [
  { city: 'Bom Jardim', state: 'RJ', type: 'Varejo', stores: [{ name: 'Parada Do Frango', instagram: 'https://www.instagram.com/frangonabrasabj/', maps: 'https://maps.app.goo.gl/VPdRuDejw1tzK4gG6' }, { name: 'Superthal', instagram: 'https://www.instagram.com/redesuperthal/?hl=pt-br', maps: 'https://maps.app.goo.gl/uvt7FvHfGjo6LQGN8' }, 'Tem De Tudo', { name: 'Mercadinho Do Trevo', instagram: 'https://www.instagram.com/mercadinho_trevo/', maps: 'https://maps.app.goo.gl/ewJQYFpDEBmk9p537' }, { name: 'Cantinho Do Pão', instagram: 'https://www.instagram.com/cantinhodopaoofc/', maps: 'https://maps.app.goo.gl/QTKEueq5b73HpowR6' }, 'Açougue Bom Jardim', { city: 'Bom Jardim', state: 'RJ', type: 'Varejo', stores: [{ name: 'Parada Do Frango', instagram: 'https://www.instagram.com/frangonabrasabj/', maps: 'https://maps.app.goo.gl/VPdRuDejw1tzK4gG6' }, { name: 'Superthal', instagram: 'https://www.instagram.com/redesuperthal/?hl=pt-br', maps: 'https://maps.app.goo.gl/uvt7FvHfGjo6LQGN8' }, 'Tem De Tudo', { name: 'Mercadinho Do Trevo', instagram: 'https://www.instagram.com/mercadinho_trevo/', maps: 'https://maps.app.goo.gl/ewJQYFpDEBmk9p537' }, { name: 'Cantinho Do Pão', instagram: 'https://www.instagram.com/cantinhodopaoofc/', maps: 'https://maps.app.goo.gl/QTKEueq5b73HpowR6' }, 'Açougue Bom Jardim', 'Aline Bar', { name: 'Beer House', instagram: 'https://www.instagram.com/beerhouse.bj/', maps: 'https://maps.app.goo.gl/E7m72qWjSWS7QzQW7' }, { name: 'Padaria Nonna Carmela', instagram: 'https://www.instagram.com/padarianonnacarmela/?hl=pt', maps: 'https://maps.app.goo.gl/WdthGvTrYnjwQm7c6' }] },, instagram: 'https://www.instagram.com/padarianonnacarmela/?hl=pt', maps: 'https://maps.app.goo.gl/WdthGvTrYnjwQm7c6' }] },
