...
const storesByCity: CityLocation[] = [
  ...
  { city: 'Duas Barras', state: 'RJ', type: 'Fábrica', stores: [{ city: 'Duas Barras', state: 'RJ', type: 'Fábrica', stores: [{ name: 'Depósito Beerbarrense', instagram: 'https://www.instagram.com/deposito_beerbarrense/?hl=pt-br', maps: 'https://maps.app.goo.gl/iTLsgo98uWR7UqETA' }, 'Açougue Nossa Senhora Dua Barras', 'Alea', 'Açougue e Mercado Castelo', { name: 'Superthal', instagram: 'https://www.instagram.com/redesuperthal/', maps: 'https://maps.app.goo.gl/Kv2SmEQNbdU4EeYp6' }] },, instagram: 'https://www.instagram.com/redesuperthal/', maps: 'https://maps.app.goo.gl/Kv2SmEQNbdU4EeYp6' }] },
