...
const storesByCity: CityLocation[] = [
  ...
  { city: 'Duas Barras', state: 'RJ', type: 'Fábrica', stores: [{ name: 'Depósito Beerbarrense', instagram: 'https://www.instagram.com/deposito_beerbarrense/?hl=pt-br', maps: 'https://maps.app.goo.gl/iTLsgo98uWR7UqETA' }, 'Açougue Nossa Senhora Dua Barras', 'Alea', { name: 'Açougue e Mercado Castelo', instagram: 'https://www.instagram.com/acougueemercadocastelo/', maps: 'https://maps.app.goo.gl/Cggq4FKjAShJ5YcF8' }, { name: 'Superthal', instagram: 'https://www.instagram.com/redesuperthal/', maps: 'https://maps.app.goo.gl/Kv2SmEQNbdU4EeYp6' }] },
  ...
  { city: 'Cantagalo', state: 'RJ', type: 'Varejo', stores: [{ name: 'Superthal', instagram: 'https://www.instagram.com/redesuperthal/?hl=pt-br', maps: 'https://maps.app.goo.gl/i3xvwWiNzGyB5HXt7' }] },
  { city: 'Cordeiro', state: 'RJ', type: 'Varejo', stores: [{ name: 'Mercado Machadinho', instagram: 'https://www.instagram.com/supermercado.machadinho/', maps: 'https://maps.app.goo.gl/jHSGrs4ZGAMw5fcg6' }, { name: 'Superthal', instagram: 'https://www.instagram.com/redesuperthal/?hl=pt-br', maps: 'https://maps.app.goo.gl/Q9H5gNAqBzeU82k6A' }] },
  { city: 'Duas Barras', state: 'RJ', type: 'Fábrica', stores: [{ name: 'Depósito Beerbarrense', instagram: 'https://www.instagram.com/deposito_beerbarrense/?hl=pt-br', maps: 'https://maps.app.goo.gl/iTLsgo98uWR7UqETA' }, 'Açougue Nossa Senhora Dua Barras', 'Alea', { name: 'Açougue e Mercado Castelo', instagram: 'https://www.instagram.com/acougueemercadocastelo/', maps: 'https://maps.app.goo.gl/Cggq4FKjAShJ5YcF8' }, { name: 'Superthal', instagram: 'https://www.instagram.com/redesuperthal/', maps: 'https://maps.app.goo.gl/Kv2SmEQNbdU4EeYp6' }] },, state: 'RJ', type: 'Fábrica', stores: [{ name: 'Depósito Beerbarrense', instagram: 'https://www.instagram.com/deposito_beerbarrense/?hl=pt-br', maps: 'https://maps.app.goo.gl/iTLsgo98uWR7UqETA' }, 'Açougue Nossa Senhora Dua Barras', 'Alea', { name: 'Açougue e Mercado Castelo', instagram: 'https://www.instagram.com/acougueemercadocastelo/', maps: 'https://maps.app.goo.gl/Cggq4FKjAShJ5YcF8' }, { name: 'Superthal', instagram: 'https://www.instagram.com/redesuperthal/', maps: 'https://maps.app.goo.gl/Kv2SmEQNbdU4EeYp6' }] },, state: 'RJ', type: 'Fábrica', stores: [{ name: 'Depósito Beerbarrense', instagram: 'https://www.instagram.com/deposito_beerbarrense/?hl=pt-br', maps: 'https://maps.app.goo.gl/iTLsgo98uWR7UqETA' }, 'Açougue Nossa Senhora Dua Barras', 'Alea', { name: 'Açougue e Mercado Castelo', instagram: 'https://www.instagram.com/acougueemercadocastelo/', maps: 'https://maps.app.goo.gl/Cggq4FKjAShJ5YcF8' }, { name: 'Superthal', instagram: 'https://www.instagram.com/redesuperthal/', maps: 'https://maps.app.goo.gl/Kv2SmEQNbdU4EeYp6' }] },, { name: 'Superthal', instagram: 'https://www.instagram.com/redesuperthal/', maps: 'https://maps.app.goo.gl/Kv2SmEQNbdU4EeYp6' }] },
  { city: 'Nova Friburgo', state: 'RJ', type: 'Varejo', stores: ['Mercado Armazém Da Serra', 'Shopping Amigos', 'Mercado Águia Da Serra', 'Boteco Curuzu', 'Villa Drinks', 'Brew', 'Sante Depósito', 'Lider Serrano', 'Santè Depósito Bebidas', 'Natan Depósito Do Zazá', 'Emporio Serrano Friburgo', 'Emporio Beer', 'Sorveteria Cesa', 'Casa De Carnes Amorim', 'Botique Das Carnes', 'Mercado Do Lucas', 'Açougue Do Jean', 'Mercado União', 'Lj Bebidas', 'AGROFRUTI', 'Colibri Bebidas', 'Arthur Ribeiro', 'Wendel Hortifruti', 'Gabriel Mercado Gb', 'Frotté', 'Pec Beer', 'Das Carnes', 'Açougue Adj', 'General Das Carnes', 'Clube Da Cevada'] },
  { city: 'Sumidouro', state: 'RJ', type: 'Varejo', stores: ['Mercado Pimpolho', 'Mercado Frio Ramos', 'JF Carnes', 'Mercado São Caetano', 'Mercado Betinho', 'Quintal Do B'] },
  { city: 'Teresópolis', state: 'RJ', type: 'Varejo', stores: ['Padaria Da Serra', 'Mercado Chc Dona Marianna', 'Jm Mercado', 'Mt Fruti', 'Ki Carnes', 'Santa Rosa', 'Cia Das Carnes', 'Mercado Mv Da Rosa', 'Casa Da Carne', 'Depósito De Bebida Pai E Filho', 'Mcc Filhos'] },
];
