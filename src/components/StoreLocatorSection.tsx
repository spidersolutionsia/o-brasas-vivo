...
const storesByCity: CityLocation[] = [
  { city: 'Bom Jardim', state: 'RJ', type: 'Varejo', stores: [{ name: 'Parada Do Frango', instagram: 'https://www.instagram.com/frangonabrasabj/', maps: 'https://maps.app.goo.gl/VPdRuDejw1tzK4gG6' }, { name: 'Superthal', instagram: 'https://www.instagram.com/redesuperthal/?hl=pt-br', maps: 'https://maps.app.goo.gl/uvt7FvHfGjo6LQGN8' }, 'Tem De Tudo', 'Mercadinho Do Trevo', 'Cantinho Do Pão', 'Açougue Bom Jardim', 'Aline Bar', 'Beer House', 'Padaria Nonna Carmela'] },
