...
const storesByCity: CityLocation[] = [
  ...
  { city: 'Duas Barras', state: 'RJ', type: 'Fábrica / Varejo', stores: [{ name: 'Depósito Beerbarrense', instagram: 'https://www.instagram.com/deposito_beerbarrense/?hl=pt-br', maps: 'https://maps.app.goo.gl/iTLsgo98uWR7UqETA' }, { name: 'Açougue Nossa Senhora Dua Barras', instagram: 'https://www.instagram.com/acouguedb/', maps: 'https://maps.app.goo.gl/BcFNbM4ZE1c3U2x39' }{ city: 'Duas Barras', state: 'RJ', type: 'Fábrica / Varejo', stores: [{ name: 'Depósito Beerbarrense', instagram: 'https://www.instagram.com/deposito_beerbarrense/?hl=pt-br', maps: 'https://maps.app.goo.gl/iTLsgo98uWR7UqETA' }, { name: 'Açougue Nossa Senhora Dua Barras', instagram: 'https://www.instagram.com/acouguedb/', maps: 'https://maps.app.goo.gl/BcFNbM4ZE1c3U2x39' }, { name: 'Açougue e Mercado Castelo', instagram: 'https://www.instagram.com/acougueemercadocastelo/', maps: 'https://maps.app.goo.gl/Cggq4FKjAShJ5YcF8' }, { name: 'Superthal', instagram: 'https://www.instagram.com/redesuperthal/', maps: 'https://maps.app.goo.gl/Kv2SmEQNbdU4EeYp6' }] }, { name: 'Açougue e Mercado Castelo', instagram: 'https://www.instagram.com/acougueemercadocastelo/', maps: 'https://maps.app.goo.gl/Cggq4FKjAShJ5YcF8' }, { name: 'Superthal', instagram: 'https://www.instagram.com/redesuperthal/', maps: 'https://maps.app.goo.gl/Kv2SmEQNbdU4EeYp6' }] },
